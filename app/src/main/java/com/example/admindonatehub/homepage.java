...
public class homepage extends AppCompatActivity {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(homepage.this, "Error starting adddata activity", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView,
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(homepage.this, managerecords.class);
    ...
    private void fetchDataFromFirebase() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ModelRecyclerViewAdapter adapter = new ModelRecyclerViewAdapter(homepage.this, arrayList);
    ...
    private void filterList(String searchText) {
        ...
        ModelRecyclerViewAdapter adapter = new ModelRecyclerViewAdapter(homepage.this, filteredList);
        recyclerView.setAdapter(adapter);
    }
    ...
    private void displayAmount() {
        ...
        transactionsRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(homepage.this, "Error fetching amount from database: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void countUsersWithSuccessTransactions() {
        ...
        transactionsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("FirebaseError", "Firebase Database Error: " + databaseError.getMessage());
                Toast.makeText(homepage.this, "Error counting users from the database: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
